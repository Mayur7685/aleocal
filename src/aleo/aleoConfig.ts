...
export const MAINNET_API_URL = 'https://api.explorer.provable.com/v1'; // Update when mainnet is live
...
export const aleoConfig = {
  ...
  network: {
    ...
    fallbackUrls: [
      ...
      'https://testnet.aleo.network/v1',
    ],
  },

  // Program configuration
  program: {
    // Program ID on the network
    programId: getEnv('VITE_ALEO_PROGRAM_ID', 'REACT_APP_ALEO_PROGRAM_ID', 'aleocal.aleo'),
    // Program source path (for local development)
    sourcePath: '/aleo/aleocal/src/main.leo',
  },
